...
// ── Season badge helper ───────────────────────────────────────────────────────
function getSeasonTag(bestTime, t) {
  ...
  const handleChange = (e) => {
   ...
   const handleSelect = (s) => {
    ...
    if (s.type === "destination") {
      navigate(`/destination-detail/${s.id}`);
    } else {
  ...
  return (
    ...
    >
      <div className="dest-card__img-wrap">
        ...
        {season && (
          <span
            className={`dest-card__season ${season.cls}`}
          >
            {season.label}
          </span>
        )}
...
function StatsSection({
  ...
  const dCount = useCountUp(
    destCount || 200,
    1800,
    visible
  );

  const sCount = useCountUp(
    stateCount || 28,
    1500,
    visible
  );

  const rCount = useCountUp(
    regionCount || 6,
    1200,
    visible
  );
...
const WHY_CARDS = [
  {
    ...
    desc: "8 UNESCO World Heritage Sites and thousands of years of living civilisation.",
  },
  {
    icon: "🍛",
    title: "Culinary Diversity",
    desc: "Every state has its own cuisine — from fiery Chettinad to delicate Kashmiri wazwan.",
  },
  {
    icon: "🎭",
    title: "Festivals & Culture",
    desc: "A festival almost every day of the year. Color, music, and devotion like nowhere else.",
  },
  {
    icon: "🏔️",
    title: "Every Landscape",
    desc: "Glaciers to beaches, deserts to rainforests — India has it all within its borders.",
  },
];
      ...
      <section className="hero" ref={heroRef}>
        ...
        <div className="hero__content">
          ...
          <h1 className="hero__title">
            {t("home2.whereEveryRoad")}
            <br />
            <em>{t("home2.tellsStory")}</em>
          </h1>
        ...
        <div className="container">
          <div className="map-cta">
            ...
            <div className="map-cta__content">
              <span className="map-cta__eyebrow">
                {t(
                  "home2.interactiveMap"
                )}
              </span>

              <h2 className="map-cta__title">
                {t("home2.findNearYou")}
              </h2>
