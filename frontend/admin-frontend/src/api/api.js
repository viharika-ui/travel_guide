...
export const getGuideBookings = (params = {}) =>
  request("/admin/guide-bookings?" + new URLSearchParams(params));
export const deleteGuideBooking = (id) =>
  request(`/admin/guide-bookings/${id}`, { method: "DELETE" });
